...
spatial_data <- sp.dat.ll  # replace with your spatial data


# Add cluster assignments to spatial data
spatial_data$cluster <- bivariate_model$classification

# Assuming your spatial data is named 'spatial_data'
subset_columns <- c("code", "IZ_NAME", "STDAREA_HA", "Shape_Leng", "Shape_Area", "SMR_2004", "cluster")
...
# Plot the spatial data with blue and red colors for each cluster
plot(subset_data, col = ifelse(subset_data$cluster == 1, "blue", "red"), main = "Spatial Distribution of Clusters (Subset)")
